...
class tareas{
	...
	function mostrar_tareas(){
		if($this->con->abrir()==true){
			return mysql_query("SELECT t.tar_codigo, t.tar_nombre, t.tar_gru_codigo, t.tar_tip_codigo, t.tar_lis_codigo, e.est_nombre from tareas t, estados e where t.tar_est_codigo = e.est_codigo");
		}
	}
